...
REMEDIATION_HINT_EN: dict[str, str] = {
    ...
    "to_date_rr": "Replace RR with YY, or better with an explicit YYYY after normalising the "
    "input — PostgreSQL does not know the RR code and silently returns year 1 BC",
