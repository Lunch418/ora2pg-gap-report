...
_MESSAGE = (
    ...
    "ни на выполнении, данные просто оказываются неверными. Заменяется на "
    "YY (00-49 → 20xx, 50-99 → 19xx у PostgreSQL работает так же) или, "
    "надёжнее, на явный четырёхзначный YYYY с приведением входных данных. "
